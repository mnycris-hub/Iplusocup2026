      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        >
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-white mb-6 tracking-tight">
            IPLUSO CUP
            <span className="block text-[#D90429] mt-2 drop-shadow-[0_0_30px_rgba(217,4,41,0.8)]">
              2026
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-[#D90429] to-[#8D021F] text-white font-bold text-lg rounded-lg hover:shadow-[0_0_40px_rgba(217,4,41,0.6)] transition-all duration-300 transform hover:scale-105 w-full sm:w-auto"
            >
              INSCREVER EQUIPA
            </button>
            <button
              onClick={() => scrollToSection("schedule")}
              className="px-8 py-4 bg-white/10 backdrop-blur-md border-2 border-white text-white font-bold text-lg rounded-lg hover:bg-white hover:text-[#D90429] transition-all duration-300 transform hover:scale-105 w-full sm:w-auto"
            >
              VER HORÁRIOS
            </button>
          </div>
