    ...
    <section className="py-20 bg-[#F5F5F5]" ref={ref}>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Hashtag */}
          <div className="inline-block bg-gradient-to-r from-[#D90429] to-[#8D021F] px-8 py-4 rounded-full mb-12 shadow-xl">
            <span className="text-white font-black text-2xl sm:text-3xl tracking-wide">
              #IPLUSOCupLisboa
            </span>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.a
            ...
            className="group"
          >
            <div className="bg-white border-2 border-gray-100 rounded-2xl p-8 text-center hover:border-[#D90429] hover:shadow-[0_0_30px_rgba(217,4,41,0.2)] transition-all duration-300 transform hover:-translate-y-2">
              <div className="w-16 h-16 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
          ...
          >
            <div className="bg-white border-2 border-gray-100 rounded-2xl p-8 text-center hover:border-[#D90429] hover:shadow-[0_0_30px_rgba(217,4,41,0.2)] transition-all duration-300 transform hover:-translate-y-2">
              <div className="w-16 h-16 bg-gradient-to-br from-[#D90429] to-[#8D021F] rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
